...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { email: @manager.email, name: @manager.name, office_number: @manager.office_number }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { email: @manager.email, name: @manager.name, office_number: @manager.office_number }
    assert_redirected_to manager_path(assigns(:manager))
  end
